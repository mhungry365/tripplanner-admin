          ...
          {tab === 'site' && (
            <div className="card max-w-lg space-y-6">
              ...
              <div className="space-y-4">
                {[
                  { label: 'App Name', value: 'TripPlanner', desc: 'Displayed in the header and emails' },
                  { label: 'Support Email', value: 'support@tripplanner.app', desc: 'Receives user support messages' },
